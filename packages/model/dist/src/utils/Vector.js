...
class Vector {
    ...
    setFromAngle(a) {
        return new Vector(Math.cos(degreeToRadian(a)), Math.sin(degreeToRadian(a))).normalize();
    }
    distanceTo(vector) {
    ...
    roundToHexCenter() {
        return coordinateConverter.fromHexToGame(coordinateConverter.fromGameToHex(this));
    }
    toOffset() {
