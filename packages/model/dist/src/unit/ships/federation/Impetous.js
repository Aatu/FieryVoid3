...
class Impetous extends Ship {
    setShipProperties() {
        ...
        this.systems.addAftSystem([
            new systems.ManeuveringThruster({ id: 201, hitpoints: 10, armor: 3 }, 3, 2),
        ...
        this.systems.addStarboardFrontSystem([
            new X2PDC30mm({ id: 101, hitpoints: 5, armor: 3 }, { start: 0, end: 180 }),
            new X2PDC30mm({ id: 102, hitpoints: 5, armor: 3 }, { start: 0, end: 180 }),
            new X2PDC30mm({ id: 103, hitpoints: 5, armor: 3 }, { start: 0, end: 180 }),
            new systems.Thruster({ id: 104, hitpoints: 10, armor: 3 }, 5, [1, 2]),
        ]);
        this.systems.addPortFrontSystem([
            new X2PDC30mm({ id: 501, hitpoints: 5, armor: 3 }, { start: 180, end: 0 }),
            new X2PDC30mm({ id: 502, hitpoints: 5, armor: 3 }, { start: 180, end: 0 }),
            new X2PDC30mm({ id: 503, hitpoints: 5, armor: 3 }, { start: 180, end: 0 }),
