...
class Fulcrum extends Ship {
    ...
    `;
        ...
        this.systems.addFrontSystem([
            ...
            new systems.ManeuveringThruster({ id: 101, hitpoints: 10, armor: 3 }, 10, 2),
            new systems.TorpedoLauncherDual72({ id: 108, hitpoints: 10, armor: 4 }),
        ]);
        this.systems.addPrimarySystem([
            new systems.EwArray({ id: 12, hitpoints: 12, armor: 6, boostPower: 5 }, 7),
            ...
            new systems.PDC30mm({ id: 14, alwaysTargetable: true }, { start: 0, end: 0 }),
        ]);
        this.systems.addAftSystem([
            ...
            new systems.ManeuveringThruster({ id: 201, hitpoints: 10, armor: 3 }, 10, 2),
            new systems.Thruster({ id: 203, hitpoints: 20, armor: 3 }, 15, 3, {
                power: 2,
            }),
            new systems.PDC30mm({ id: 214, alwaysTargetable: true }, { start: 0, end: 0 }),
            new systems.Radiator5x40({ id: 316 }),
            new systems.CargoBay({ id: 317, hitpoints: 10, armor: 4 }, 100),
        ]);
        this.systems.addStarboardFrontSystem([
            new systems.PDC30mm({ id: 15, hitpoints: 5, armor: 3 }, { start: 0, end: 180 }),
        ]);
        this.systems.addStarboardAftSystem([
            new systems.PDC30mm({ id: 215, hitpoints: 5, armor: 3 }, { start: 0, end: 180 }),
            new systems.Radiator5x40({ id: 216 }),
        ]);
        this.systems.addPortFrontSystem([
            new systems.PDC30mm({ id: 13, hitpoints: 5, armor: 3 }, { start: 180, end: 0 }),
        ]);
        this.systems.addPortAftSystem([
            new systems.PDC30mm({ id: 213, hitpoints: 5, armor: 3 }, { start: 180, end: 0 }),
