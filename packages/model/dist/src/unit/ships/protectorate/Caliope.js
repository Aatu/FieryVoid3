...
class Caliope extends Ship {
    ...
    `;
        ...
        this.systems.addFrontSystem([
            ...
            new systems.PDC30mm({ id: 114, hitpoints: 5, armor: 3 }, { start: 200, end: 160 }),
            new systems.PDC30mm({ id: 115, hitpoints: 5, armor: 3 }, { start: 200, end: 160 }),
            ...
            new systems.ManeuveringThruster({ id: 101, hitpoints: 10, armor: 3 }, 10, 3),
        ]);
        ...
        this.systems.addStarboardFrontSystem([
            ...
            new systems.RailgunTurreted2x140mm({ id: 213, hitpoints: 8, armor: 4 }, { start: 330, end: 90 }),
            new systems.PDC30mm({ id: 202, hitpoints: 4, armor: 3 }, { start: 0, end: 180 }),
            new systems.AutoCannon85mm({ id: 203, hitpoints: 6, armor: 3 }, { start: 330, end: 160 }),
            new systems.AutoCannon85mm({ id: 204, hitpoints: 6, armor: 3 }, { start: 330, end: 160 }),
        ]);
        this.systems.addPortFrontSystem([
            new systems.RailgunTurreted2x140mm({ id: 612, hitpoints: 8, armor: 4 }, { start: 270, end: 30 }),
            new systems.Thruster({ id: 601, hitpoints: 10, armor: 3 }, 15, [4, 5]),
            new systems.AutoCannon85mm({ id: 603, hitpoints: 6, armor: 3 }, { start: 200, end: 30 }),
            new systems.PDC30mm({ id: 602, hitpoints: 4, armor: 3 }, { start: 180, end: 0 }),
            new systems.AutoCannon85mm({ id: 604, hitpoints: 6, armor: 3 }, { start: 200, end: 30 }),
        ]);
        this.systems.addAftSystem([
            new systems.ManeuveringThruster({ id: 401, hitpoints: 10, armor: 3 }, 10, 3),
