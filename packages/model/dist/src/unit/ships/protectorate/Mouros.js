...
class Mouros extends Ship {
    setShipProperties() {
        ...
        this.systems.addFrontSystem([
            new systems.ManeuveringThruster({ id: 101, hitpoints: 10, armor: 3 }, 3, 2),
        ...
        this.systems.addStarboardAftSystem([
            new RailgunTurreted32gw({ id: 301, hitpoints: 10, armor: 3 }, { start: 0, end: 183 }),
            new systems.Thruster({ id: 308, hitpoints: 10, armor: 3 }, 5, [1, 2]),
        ]);
        this.systems.addPortAftSystem([
            new RailgunTurreted32gw({ id: 501, hitpoints: 10, armor: 3 }, { start: 177, end: 0 }),
