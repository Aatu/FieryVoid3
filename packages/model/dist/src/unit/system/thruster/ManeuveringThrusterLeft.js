...
import ThrustChannelSystemStrategy, { THRUSTER_DIRECTION, } from "../strategy/ThrustChannelSystemStrategy";
class ManeuveringThrusterLeft extends ShipSystem {
    constructor(args, channel, evasion) {
        super(args, [
            new ThrustChannelSystemStrategy(channel, [THRUSTER_DIRECTION.PIVOT_RIGHT, THRUSTER_DIRECTION.MANOUVER], [
