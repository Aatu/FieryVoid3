import StandardDamageStrategy, { isStandardDamagePayload, } from "./StandardDamageStrategy";
import CombatLogDamageEntry from "../../../../combatLog/CombatLogDamageEntry";
class BurstDamageStrategy extends StandardDamageStrategy {
    shotsFormula;
    maxShots;
    grouping;
    constructor(damageFormula, armorPiercingFormula, shotsFormula = 6, maxShots = 6, grouping = 10) {
    ...
    applyDamageFromWeaponFire(payload) {
        ...
        Array.from(Array(shots)).map(() => {
            ...
            this.doDamage({ shooterPosition: payload.shooter.getPosition(), ...payload }, result, null);
            return result;
        });
    }
    ...
    getNumberOfShots({ hitResolution, }) {
