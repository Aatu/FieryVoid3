...
import { Ammo140mmAP, Ammo30mm, } from "../../system/weapon/ammunition/conventional";
import { Torpedo158HE, Torpedo158MSV, Torpedo72HE, Torpedo72MSV, } from "../../system/weapon/ammunition/torpedo";
class TestShip extends Ship {
    setShipProperties() {
        ...
        this.systems.addPrimarySystem([
            ...
            new systems.ManeuveringThruster({ id: 10, hitpoints: 10, armor: 3 }, 9, 3),
