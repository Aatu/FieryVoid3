...
import { addToDirection, getCompassHeadingOfPoint, hexFacingToAngle, } from "../../../../utils/math";
class WeaponArcStrategy extends ShipSystemStrategy {
    ...
    isPositionOnArc({ targetPosition }) {
        ...
        const targetHeading = getCompassHeadingOfPoint(shooter.getPosition(), targetPosition);
