...
class AlwaysTargetableSystemStrategy extends ShipSystemStrategy {
    ...
    isAlwaysTargetable = (_, previousResponse = false) => {
    ...
    getMessages = (_, previousResponse = []) => {
        ...
        if (this.turnsOfflineToCancel === null) {
            ...
            if (this.turnsOffline >= this.turnsOfflineToCancel) {
                ...
                previousResponse.push({
                    value: `This system has to be ofline ${this.turnsOfflineToCancel - this.turnsOffline} more turn to not be a valid target`,
                });
            }
        }
        return previousResponse;
