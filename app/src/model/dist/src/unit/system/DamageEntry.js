...
class DamageEntry {
    ...
    constructor(amount = 0, armor = 0) {
        if (!Number.isInteger(amount) ||
            ...
            Number.isNaN(armor)) {
            throw new Error(`Trying to construct damageEntry with invalid damage or armor ${amount}, ${armor}`);
        }
        this.amount = amount;
        if (this.amount < 0) {
            this.amount = 0;
    ...
    deserialize(data) {
        ...
        if (!Number.isInteger(this.amount) ||
            ...
            throw new Error(`Trying to deserialize damageEntry with invalid damage or armor ${this.amount}, ${this.armor}`);
        }
        return this;
    }
    getDamage() {
