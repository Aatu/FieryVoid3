  ...
  function startReplayOrRequestGamedata() {
    if (this.replayTurn === this.gamedata.turn) {
      ...
      if (!this.animationStrategy) {
        this.changeAnimationStrategy(
          new IdleAnimationStrategy(this.shipIconContainer, this.gamedata.turn)
        );
