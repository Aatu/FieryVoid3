  ...
  chooseInterceptor(
    ...
    const interceptor = gameData.ships
      ...
      .filter((weapon) => {
        ...
        const numberOfIntercepts = weapon.handlers.getNumberOfIntercepts();
      ...
      .sort((a, b) => {
        const changeA = a.handlers.getInterceptChance(target, flight);
        const changeB = b.handlers.getInterceptChance(target, flight);
